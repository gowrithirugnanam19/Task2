...
public String meth6(@RequestBody StudentBean sb) {
	...
	if(sb.getName().equals("AD001")){
		return "redirect:./userData";
	}
	if(sb.getName().equals("US001")) {
